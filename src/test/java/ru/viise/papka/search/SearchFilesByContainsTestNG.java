...
import ru.viise.papka.search.SearchByContains;
import ru.viise.papka.search.SearchFilesByFolderNameInSystem;
...
public class SearchFilesByContainsTestNG {
    ...
    public void answer() throws NotFoundException {
        ...
        Search<List<File>, String> search = new SearchByContains<>(
                new SearchFilesByFolderNameInSystem(name));
